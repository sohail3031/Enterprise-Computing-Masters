...
T1 Spring Framework
T1.1 [3/3/*] Hand on IoC
T1.2 [3/3/*] Hand on AOP
T1.3 [3/3/*] Web component of Spring MVC
T1.4 [3/3/*] Spring Boot Web applications
T1.5 [3/3/*] Spring on WildFly

T2 OSGi Framework
T2.1 [3/3/*] Equinox OSGi framework
T2.2 [3/3/*] Creating OSGi bundles
T2.3 [3/3/*] Apache Felix
T2.4 [3/3/*] Apache Karaf
...
T4 Docker
T4.1 [3/3/*] Install Docker and operations
T4.2 [3/3/*] Creating docker images
...
T6 Hand on Jenkins
T6.1 [4/4/*] Jankins Installation and configuration
T6.2 [4/4/*] Creating Jenkins Jobs
