...
// 		tracker = new ServiceTracker(context, StatsOSGi.class, null);
// 		tracker.open();
...
//                 try {
//                    httpService.registerServlet("/stats-osgi", new OSGiServlet(service), null, null);
...
//                 try {
//                     ((HttpService) service).unregister("/stats-osgi");
